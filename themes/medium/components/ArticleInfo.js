...
export default function ArticleInfo(props) {
  ...
  return (<>
        {/* title */}
        <h1 className="text-4xl md:text-5xl font-bold pt-12 pb-6 leading-tight text-black dark:text-white">{siteConfig('POST_TITLE_ICON') && <NotionIcon icon={post?.pageIcon} />}{post?.title}</h1>

        {/* meta */}
        <section className="py-4 items-center text-sm text-gray-500 dark:text-gray-400 px-1 border-b border-gray-200 dark:border-gray-800 pb-6 mb-6">

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NEWSWIRE INDIA', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Latest news from around the world', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.newswireindiaonline.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Latest News, Breaking News, Whats New, Trending News', // 网站关键词 英文逗号隔开
  ...
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://www.newswireindiaonline.com/', // 备案查询链接，如果用了萌备等备案请在这里填写
  ...
  GREETING_WORDS:
    ...
    'Hi，welcome to my thinking site, Hi，this is Johnny, Hi，this site is used to execute an effective thinking, Hi great thinking comes from small things🎉',
